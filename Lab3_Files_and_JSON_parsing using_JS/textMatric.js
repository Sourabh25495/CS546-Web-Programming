let Tmetrics = exports = module.exports; // MODULE EXPORTED TO APP.JS

Tmetrics.textMatric = function(data) // FUNCTION TO FIND NUMBER OF WORDS,LETTERS,UNIQUE WORDS ETC....
{
    try
    {
        if(data === 'undefined')
